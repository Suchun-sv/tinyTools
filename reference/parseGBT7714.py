...
useras = {
    'J' : ['author.title[usera].journal,year,volume(number):pages[urldate].url.doi.',
           'author.title[usera].journal,year,volume(number):pages.url.',
           'author.title[usera].journal,year,volume(number):pages.'],
